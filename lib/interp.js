...
import { TxIn } from './tx-in'
  ...
  class Interp extends Struct {
    ...
    * eval () {
    ...
    step () {
      ...
      // DISABLED @GENESIS REVERT: if (chunk.buf && chunk.buf.length > Interp.MAX_SCRIPT_ELEMENT_SIZE) {
      // DISABLED @GENESIS REVERT:   this.errStr = 'SCRIPT_ERR_PUSH_SIZE'
      // DISABLED @GENESIS REVERT:   return false
      // DISABLED @GENESIS REVERT: }
  ...
  // DISABLED @GENESIS REVERT: Interp.MAX_SCRIPT_ELEMENT_SIZE = 520
